...
interface MovingBorderBtnProps extends React.ComponentPropsWithoutRef<"button"> {
  borderRadius?: string;
    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={cn(
              "h-20 w-20 opacity-[0.8] bg-[radial-gradient(var(--indigo-600)_50%,transparent_80%)]",
              borderClassName
            )}
          />
        </MovingBorder>

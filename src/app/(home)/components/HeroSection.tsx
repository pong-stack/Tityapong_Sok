      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center min-h-[80vh]">
          ...
          <div className="order-2 lg:order-1 space-y-6 sm:space-y-8 text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-green-500/10 border border-green-500/20 dark:border-green-600/20 backdrop-blur-sm">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Passionate IT Engineering student at Royal University of Phnom Penh, specializing in
                modern web development. I craft digital experiences using cutting-edge technologies
                like React, Next.js, and Node.js. Always eager to learn and build innovative
                solutions.
              </p>
            </div>
          </div>
